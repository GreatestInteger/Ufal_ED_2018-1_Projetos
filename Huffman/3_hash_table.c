...
void pass_through_edges_and_add_characters(hash_table *ht, node *huffman_tree, unsigned char *bit_string, int index, unsigned char bit) { // Updates "bits" in the hash table with the new byte map.
